...
class HomeScreen extends Screen {
	...
	protected HomeScreen() {
		...
		left.setBackground(new Background(
				new BackgroundImage(new Image(ClassLoader.getSystemResource("images/wall_background.png").toString()),
						BackgroundRepeat.REPEAT, BackgroundRepeat.REPEAT,
						new BackgroundPosition(Side.LEFT, 1, true, Side.TOP, 1, true), BackgroundSize.DEFAULT)));
